  ...
  <div className={styles.row}>
    <div className={styles.col} style={{ backgroundColor: color }}>
      <div className={styles.wrap}>
        <div className={cn("h1", styles.title)}>Auctions ending soon</div>
        <Link href="/discover">
          <a className={cn("button-white button-counter", styles.button)}>
            explorer more
            <span>109</span>
          </a>
        </Link>
              ...
              <div className={styles.details}>
                ...
                <div className={styles.line}>
                  <div className={styles.box}>
                    <div className={styles.category}>Current bid</div>
