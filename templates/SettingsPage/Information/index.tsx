...
const Information = ({}: InformationProps) => {
  const [email, setEmail] = useState<string>("https://wanderverse.ai");
  const [name, setName] = useState<string>("Dash");
  const [bio, setBio] = useState<string>("");
  const [site, setSite] = useState<string>("https://wanderverse.ai");
  const [twitter, setTwitter] = useState<string>("https://wanderverse.ai");
  const [facebook, setFacebook] = useState<string>("https://wanderverse.ai");
